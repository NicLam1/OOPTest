...
//     private ZooModel<Image, DetectedObjects> segmentationModel; // will be null if segmentation model fails to load
...
//     @PostConstruct
//     public void init() { // Loads OpenCV & Segmentation Model >> Used for TODO
//         try {
